...
```
![Delivery stream variable](/static/images/5-2-delivery-stream-var.png)
...
```
![Lambda function name](/static/images/module5-2-simulator-getname.png)
...
```
![Invoke Lambda function](/static/images/module5-2-simulator-invoke-lambda.png)
...
![Lambda function name](/static/images/module5-2-simulator-s3b.png)
...
Next, you will analyze the data for business insights with Amazon QuickSight. To start the next section, [click here to continue](./3-quicksight).