...
![Module 1 backend-architecture](/static/images/module1-backend-arch.png)
...
![Module 1 bucket](/static/images/1-app-deploy-bucket.jpg)
...
![Module 1 env vars](/static/images/1-app-deploy-envvars.png)
...
::alert[Ignore any NPM warnings or errors - do not run npm audit]{type="warning"}

3. Run the import script:
```
node ./importData.js $AWS_REGION $DDB_TABLE
```
![Module 2 Populate Table](/static/images/1-app-deploy-import.png)
...
![Module 1 open InitStateAPIURL](/static/images/module2-open-initstateAPIURL.png)
