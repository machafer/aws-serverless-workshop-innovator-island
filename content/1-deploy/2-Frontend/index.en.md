...
![Module 1 architecture](/static/images/module1-arch.png)
...
![Module 1 create repo](/static/images/module1-create-repo.png)

You will see when the CodeCommit repository is successfully created.

![Module 1 repo success](/static/images/module1-repo-success.png)
...
::alert[Make sure your region is set to the same region you initially selected for Cloud9.]{type="warning"}
...
![Module 1 cloud9 files](/static/images/module1-cloud9files.png)
...
```
![Module 1 git push](/static/images/module1-git-push.png)
...
![Module 1 amplify splash](/static/images/module1-amplify-splash.png)

3. Under *Host your web app*, select **AWS CodeCommit** and select **Continue**.

![Module 1 connect app](/static/images/module1-connect-app.png)

4. Select *theme-park-frontend* under **Recently updated repositories**, then choose *main* under **Branch**. Select **Next**.

![Module 1 add repo](/static/images/module1-amplify-add-repo.png)
...
![Module 1 amplify URL](/static/images/module1-amplify-URL.png)
...
![Module 1 browser](/static/images/1-app-deploy-browser.jpg)