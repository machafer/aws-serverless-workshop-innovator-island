...
### Question 1 ###
:::expand{header="Why is ride updated every minute? Which line in the code causes that?"}
...
### Question 2 ###
::expand[-  In the Lambda function you created in this module, you add a "Trigger" from SNS. This causes Lambda to be invoked by the SNS message.]{header="How is the message passed from SNS to IoT topic?"}

### Question 3 ###

:::expand{header="How does the frontend application retrieve messages from the IoT topic?"}
