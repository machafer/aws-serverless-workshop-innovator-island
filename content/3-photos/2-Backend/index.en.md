...
![Module 4 architecture](/static/images/module4-architecture.png)
...
1. [Creating the chromakey Lambda function](./2-backend/1-chromakey)
2. [Creating the compositing Lambda function](./2-backend/2-compositing)
3. [Creating the post-processing notification Lambda function](./2-backend/3-postprocess)

To start the first section, [click here to continue](./2-backend/1-chromakey).